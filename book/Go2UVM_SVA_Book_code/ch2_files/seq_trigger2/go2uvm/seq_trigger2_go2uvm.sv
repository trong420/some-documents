...
* Generated on   : 2016-06-04 15:09:42
********************************************/ 



// Generating SystemVerilog interface for module: seq_trigger2
// ---------------------------------------------------------
interface seq_trigger2_if (input logic clk);
  logic  [0:0] reset_n;
  logic  [0:0] done;
  logic  [0:0] load_mem;
  logic  [0:0] ready;
...
class seq_trigger2_test extends go2uvm_base_test;
  // Create a handle to the actual interface
  virtual seq_trigger2_if vif;
  task reset;
...
#200 $finish;   // this.vif.cb.inp_1 <= 1'b0;
    // this.vif.cb.inp_2 <= 22;
    // repeat (5) @ (this.vif.cb);
    `uvm_info (log_id, "End of main", UVM_MEDIUM)
  endtask : main
endclass : seq_trigger2_test

module seq_trigger2_go2uvm;
  timeunit 1ns;
  timeprecision 1ns;
  ...
  // Interface instance
  seq_trigger2_if seq_trigger2_if_0 (.*);

  // Connect TB clk to Interface instance clk

  // DUT instance
  seq_trigger2 seq_trigger2_0 (.clk(clk),
                    .reset_n(seq_trigger2_if_0.reset_n),
                    .done(seq_trigger2_if_0.done),
		    .load_mem(seq_trigger2_if_0.load_mem),
		    .ready2(seq_trigger2_if_0.ready2),
		    .ready(seq_trigger2_if_0.ready));


  // Using VW_Go2UVM
  seq_trigger2_test seq_trigger2_test_0;
  initial begin : go2uvm_test
    seq_trigger2_test_0 = new ();
    // Connect virtual interface to physical interface
    seq_trigger2_test_0.vif = seq_trigger2_if_0;
    // Kick start standard UVM phasing
    run_test ();
  end : go2uvm_test
endmodule : seq_trigger2_go2uvm
