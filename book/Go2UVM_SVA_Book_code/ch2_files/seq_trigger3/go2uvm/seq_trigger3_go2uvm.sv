...
// ---------------------------------------------------------
interface seq_trigger3_if (input logic clk);
  logic  [0:0] reset_n;
  logic  [0:0] done;
  logic  [0:0] load_mem;
  logic  [0:0] ready;
...
module seq_trigger3_go2uvm;
  ...
  // DUT instance
  seq_trigger3 seq_trigger3_0 (.clk(clk),
                    .reset_n(seq_trigger3_if_0.reset_n),
                    .done(seq_trigger3_if_0.done),
		    .load_mem(seq_trigger3_if_0.load_mem),
		    .ready(seq_trigger3_if_0.ready),
		    .ready2(seq_trigger3_if_0.ready2));
